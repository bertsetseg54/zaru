...
export default function Login() {
  ...
  const handleImageChange = (e) => {
    ...
    if (file) {
      ...
      // OrgProfile-т харуулах preview URL-г context-д хадгална
      setOrg((prev) => ({ ...prev, image: previewUrl }));
    }
  };
            ...
            <>
              ...
              <div className="mb-4">
                ...
                >
                  ...
                  <option value="Цагаан идээ">Цагаан идээ</option>
                  <option value="Амьтан">Амьтан</option>
